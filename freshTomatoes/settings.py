...
DATABASES = {
    'default': {
        ...
        'NAME': 'freshTomatoes.sqlite',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'freshTomatoes.com']
...
#AUTHENTICATION_BACKENDS = ['freshTomatoes.api.auth.AlwaysRootBackend']
